...
_UNIFIED_HEADER = "<header class='site-header'><div class='site-header__inner'><a class='site-brand' href='/' aria-label='AlphaLab AI home'><span class='site-brand__mark' aria-hidden='true'>A</span><span class='site-brand__text'><strong>AlphaLab AI</strong><small>Signal, not noise.</small></span></a><nav class='site-nav' aria-label='Primary navigation'><a href='/'>Latest News</a><a href='/#categories'>Categories</a><a href='/about'>About</a><a href='/subscribe'>Subscribe</a><a class='site-nav__channel' href='https://t.me/alphalabai_en' target='_blank' rel='noopener noreferrer'>Telegram EN</a><a class='site-nav__channel' href='https://t.me/alphalabai_ru' target='_blank' rel='noopener noreferrer'>Telegram RU</a></nav><button id='theme-toggle' class='theme-toggle' type='button' aria-label='Toggle dark mode'>◐</button></div></header>"
_UNIFIED_FOOTER = "<footer class='site-footer'><div class='container footer-inner'><div class='footer-brand-block'><a class='footer-brand' href='/' aria-label='AlphaLab AI home'><strong>AlphaLab AI</strong></a><p>Signal, not noise.</p><p class='footer-description'>AI-assisted editorial summaries with links to original sources.</p></div><nav class='footer-links' aria-label='Explore'><strong>Explore</strong><a href='/'>Latest News</a><a href='/#categories'>Categories</a><a href='/about'>About</a><a href='/subscribe'>Subscribe</a></nav><nav class='footer-links' aria-label='Channels'><strong>Channels</strong><a href='https://t.me/alphalabai_en' target='_blank' rel='noopener noreferrer'>Telegram EN</a><a href='https://t.me/alphalabai_ru' target='_blank' rel='noopener noreferrer'>Telegram RU</a><a href='/rss'>RSS</a></nav><nav class='footer-links' aria-label='Editorial'><strong>Editorial</strong><a href='/about#contact'>Contact</a><a href='/about#corrections'>Corrections</a><a href='/about#privacy'>Privacy</a><a href='/about#original-source-policy'>Original source policy</a></nav></div><div class='container footer-bottom'><small>© 2026 AlphaLab AI</small><small>AI-assisted editorial summaries with links to original sources.</small></div></footer>"
...
class HTMLResponse(_HTMLResponse):
    def __init__(self, content="", *args, **kwargs):
        ...
        elif isinstance(content, str) and "<body" in content:
            content = content.replace("<body>", "<body>" + _UNIFIED_HEADER, 1)
            content = content.replace("</body>", _UNIFIED_FOOTER + "</body>", 1)
            theme_script = "<script>(function(){try{var t=localStorage.getItem('alphalab-theme');if(t==='dark'||t==='light')document.documentElement.dataset.theme=t;var b=document.getElementById('theme-toggle');if(b&&!b.dataset.bound){b.dataset.bound='1';b.addEventListener('click',function(){var n=document.documentElement.dataset.theme==='dark'?'light':'dark';document.documentElement.dataset.theme=n;localStorage.setItem('alphalab-theme',n);});}}catch(e){}})();</script>"
            content = content.replace("</head>", theme_script + "<script src='/static/app.js' defer></script></head>", 1)
...
def create_app(store=None, email_sender=None):
    ...
    def page(request: Request, article_id:str):
        ...
        image_for_meta = image_url if image_parsed.scheme in ('http', 'https') and image_parsed.netloc else f"{base}/static/default-og.svg"
        image_meta = f"<meta property='og:image' content='{escape(image_for_meta,quote=True)}'><meta name='twitter:image' content='{escape(image_for_meta,quote=True)}'>"
        ...
        image_html = f"<img class='article-hero-image' src='{escape(image_url,quote=True)}' alt='{escape(title,quote=True)}' loading='lazy'>" if image_url and image_parsed.scheme in ('http', 'https') and image_parsed.netloc else "<div class='article-hero-fallback' aria-hidden='true'>A</div>"
    ...
    def about():
        ...
        return HTMLResponse(f"<!doctype html><html lang='en'><head><meta charset='utf-8'><meta name='viewport' content='width=device-width, initial-scale=1'><title>About AlphaLab AI</title><meta name='description' content='Independent AI and technology intelligence with transparent links to original sources.'><link rel='canonical' href='{escape(base + '/about', quote=True)}'><link rel='stylesheet' href='/static/styles.css'></head><body><main class='about-page'><article class='article-card'><h1>About AlphaLab AI</h1><p>AlphaLab AI is an independent AI and technology intelligence publication focused on meaningful developments across artificial intelligence, developer infrastructure, open source, research, cloud platforms, cybersecurity and emerging technology.</p><h2>What we do</h2><p>We collect signals from trusted primary sources, research publications, engineering blogs and selected technology communities. AI-assisted editorial workflows help summarize, translate and organize the material, while every article preserves a transparent link to its original source.</p><h2 id='principles'>Editorial principles</h2><ul><li>Relevance over volume</li><li>Primary sources where possible</li><li>Clear attribution and concise explanation</li><li>No fabricated reporting</li></ul><h2>Distribution</h2><p>AlphaLab AI website, Telegram EN, Telegram RU and other enabled public channels.</p><h2 id='contact'>Contact</h2><p>For partnerships, sponsorships, editorial inquiries or corrections, use our public Telegram channels.</p><p><a class='button primary' href='https://t.me/alphalabai_en' target='_blank' rel='noopener noreferrer'>Contact via Telegram EN</a></p><h2 id='corrections'>Corrections</h2><p>Report an error through the contact channel; material may be updated when warranted.</p><h2 id='privacy'>Privacy</h2><p>We use basic server logs, subscription records when provided, and links to external publishers. We do not expose private account details.</p><h2 id='original-source-policy'>Original source policy</h2><p>AlphaLab AI provides AI-assisted editorial summaries. Original publishers retain ownership of source material, and every publication links to the original source.</p></article></main></body></html>")
