...
class PublicationBuilder:
    def build(self, item, language="en") -> Publication:
        ...
        title, summary = str(value("title")), str(value("summary")); content = str(value("content")); variant=LanguageVariant(language,title,summary,content or summary,summary,tuple(value("keywords",()) or ()),canonical)
